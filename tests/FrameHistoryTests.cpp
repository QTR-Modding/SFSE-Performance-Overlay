...
int main()
{
    ...
    Check(CalculateLayout(1920, 300, 0, 3).columns == 1, "vertical layout");
    Check(CalculateLayout(1920, 300, 0.5F, 3).columns == 2, "two-column reflow");
    Check(CalculateLayout(1920, 300, 1, 3).columns == 3, "horizontal layout");
    Check(CalculateLayout(700, 300, 1, 3).columns == 2, "screen-limited reflow");
    Check(CalculateLayout(1920, 300, 1, 1).width == 300, "hidden sections do not leave gaps");
    Check(CalculateLayout(200, 300, 1, 3).width == 200, "narrow screen clamp");
